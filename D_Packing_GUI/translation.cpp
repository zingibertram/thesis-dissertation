...
const QString TrRu::dffSqr = QString::fromUtf8("Плотность полосы");
const QString TrRu::stripLength = QString::fromUtf8("Длина полосы");
const QString TrRu::stripSquare = QString::fromUtf8("Площадь полосы");
const QString TrRu::orthoPolygonSquare = QString::fromUtf8("Площадь ортогональных многоугольников");
const QString TrRu::dffMaximum = QString::fromUtf8("Максимизированное значение двойственной функции");
...
const QString TrRu::damagedRes = QString::fromUtf8("Невозможно сохранить. Результат не вычислен");
